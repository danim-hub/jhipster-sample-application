package danim.sample.repository;

import danim.sample.JhipsterSampleApplicationApp;
import danim.sample.config.Constants;
import danim.sample.config.audit.AuditEventConverter;
import danim.sample.domain.PersistentAuditEvent;
...
import static danim.sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
