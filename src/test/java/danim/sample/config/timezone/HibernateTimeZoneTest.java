package danim.sample.config.timezone;

import danim.sample.JhipsterSampleApplicationApp;
import danim.sample.repository.timezone.DateTimeWrapper;
import danim.sample.repository.timezone.DateTimeWrapperRepository;
