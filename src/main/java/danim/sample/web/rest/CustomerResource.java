...
import danim.sample.web.rest.errors.BadRequestAlertException;
import danim.sample.web.rest.util.HeaderUtil;
...
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationCustomer";
